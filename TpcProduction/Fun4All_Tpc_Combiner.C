...
void Fun4All_Tpc_Combiner(int nEvents = 0,
                          const std::string &input_file00 = "tpc00.list",
                          const std::string &input_file01 = "tpc01.list",
                          const std::string &input_file02 = "tpc02.list",
                          const std::string &input_file03 = "tpc03.list",
                          const std::string &input_file04 = "tpc04.list",
                          const std::string &input_file05 = "tpc05.list",
                          const std::string &input_file06 = "tpc06.list",
                          const std::string &input_file07 = "tpc07.list",
                          const std::string &input_file08 = "tpc08.list",
                          const std::string &input_file09 = "tpc09.list",
                          const std::string &input_file10 = "tpc10.list",
                          const std::string &input_file11 = "tpc11.list",
                          const std::string &input_file12 = "tpc12.list",
                          const std::string &input_file13 = "tpc13.list",
                          const std::string &input_file14 = "tpc14.list",
                          const std::string &input_file15 = "tpc15.list",
                          const std::string &input_file16 = "tpc16.list",
                          const std::string &input_file17 = "tpc17.list",
                          const std::string &input_file18 = "tpc18.list",
                          const std::string &input_file19 = "tpc19.list",
                          const std::string &input_file20 = "tpc20.list",
                          const std::string &input_file21 = "tpc21.list",
                          const std::string &input_file22 = "tpc22.list",
                          const std::string &input_file23 = "tpc23.list")
{
  ...
  {
    SingleTpcPoolInput *sngl = new SingleTpcPoolInput("TPC_" + std::to_string(i));
    //    sngl->Verbosity(3);
