...
void Fun4All_MvtxStandalone_Combiner(int nEvents = 0,
		      ...
		      const string &input_file05 = "mvtx-flx5.list")
{
  ...
  Fun4AllOutputManager *out = new Fun4AllDstOutputManager("out","mvtxCombinerOutput.root");
  se->registerOutputManager(out);

  se->run(nEvents);

//  for (auto& sngl : mvtxSngl)
//  {
//  }
