...
//	double phaseAhv[NPHASE]	= {0};
	...
	for (int i=0;i<2000;i++){
		...
		//
		if (irun<=49722){ iphase=0; }
		else if (irun<=50025){ iphase=1; }
		else if (irun<=50458){ iphase=2; }
		else if (irun<=50936){ iphase=3; }
		else if (irun<=51109){ iphase=4; }
		else if (irun<=51191){ iphase=5; }
		else if (irun<=51301){ iphase=6; } 
		else if (irun<=51495){ iphase=7; } 
		else { iphase=8; } 
        //
...
bool CheckHV( const int irun){
	if (irun>=49706&&irun<=49713){ return true; }
 	if (irun>=50006&&irun<=50014){ return true; }
 	if (irun>=50021&&irun<=50025){ return true; }
	if (irun>=50438&&irun<=50440){ return true; }
	if (irun>=50444&&irun<=50449){ return true; }
	if (irun>=50916&&irun<=50921){ return true; }
	if (irun>=50933&&irun<=50936){ return true; }
