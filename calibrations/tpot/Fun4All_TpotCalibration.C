#include <GlobalVariables.C> // GlobalVariables.C has to be first
...
int Fun4All_TpotCalibration(
  ...
  const std::string &inputFile = "/sphenix/lustre01/sphnxpro/physics/TPOT/calib/TPOT_ebdc39_calib-00074871-0000.evt",
  const std::string &calibrationFile = "TPOT_Pedestal-00074871-0000.root",
  const std::string &evaluationFile = "MicromegasCombinedDataCalibration-00074871-0000.root"
  )
{
  // print inputs
