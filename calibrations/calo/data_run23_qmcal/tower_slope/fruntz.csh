...
source /opt/sphenix/core/bin/sphenix_setup.csh -n new.9

setenv JFINSTALL /phenix/scratch/jfrantz/install/sphenix
...
cd /sphenix/user/jfrantz/dataJune12/tsfitting/
#condor/links9613/

if ($1 > 1) then
echo “job $1 : not logging to .roothist”
setenv ROOT_HIST 0
endif

# root.exe -q -b -x  tower_slope_run23/flatoneEtaAtATime_do_eta_fit2_emc.C\(\"dreff_ref.root\",\"deuzff_tofit.root\",$1,\"ffrout/\"\)

 root.exe -q -b -x  tower_slope_run23/realflatoneEtaAtATime_do_eta_fit2_emc.C\(\"deuzff_tofit.root\",$1,\"ffrout/\"\)
echo ' '
echo ' '
echo 'END: '`date`
echo ' '
