...
void dst_simple_towerslope_runmacro(int nevents = 1e5, const char *fname = "/sphenix/user/sregmi/FINAL_VERSION/tower_slope_old_tower_method/3_RawWaveformTowerBuilder/macro/testoutput_400.root", const char * outfile =  "defout.root")

{
  ...
  ClusterBuilder->set_threshold_energy(0.042);  // This threshold should be the same as in CEMCprof_Thresh**.root file below
