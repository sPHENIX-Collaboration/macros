...
setenv JFINSTALL /phenix/scratch/jfrantz/install/sphenix_tst1nov23
...
cd /sphenix/user/jfrantz/thdatNov22/pimacs/
...
setenv ROOT_HIST 0
 ...
 root.exe -b <<EOF
   .L wholeIter_Pi0EtaByEta.C
    wholeIter_Pi0EtaByEta(300,1,"input615.list","inpCDB/m_clust_pi0_iter17_CDB.root", "./iterTest1/", "./");
   .q
EOF

 root.exe -b <<EOF
   .L wholeIter_Pi0EtaByEta.C
    wholeIter_Pi0EtaByEta(160,2,"input615.list","inpCDB/m_clust_pi0_iter17_CDB.root", "./iterTest1/", "./");
   .q
EOF
