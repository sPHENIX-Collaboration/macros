...
int spiNo2(
    const int nEvents = 600,
    const std::string &outputFile = "oldoutput2",
...
//  std::string outputfile = outputFile2 + "_ho4ho_eval.root";
  ...
  std::string outputfile3 = outputFile2 + "_towinfo_pi.root";
...
//  std::string outputfile6 = outputFile2 + "_emcal.root";
  ...
  */
  ...
  std::cout << "successful registration of pi0 2" << std::endl;
