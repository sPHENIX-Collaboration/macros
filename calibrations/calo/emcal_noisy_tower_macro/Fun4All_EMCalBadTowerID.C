...
void Fun4All_EMCalBadTowerID(const int nEvents = 5000, const std::string &inFile = "DST_CALO_run1auau_ana391_2023p006-00021813-1388.root", const std::string &inName = "commissioning3.root", const std::string&  /*cdbname*/ = "test.root", float  /*adccut_sg*/ = 150, float  /*adccut_k*/ = 150,float  /*sigmas_lo*/ = 4, float  /*sigmas_hi*/ = 4, float  /*SG_f*/ = 0.05, float  /*Kur_f*/ = 0.05, float  /*region_f*/ = 1.0, int pass = 0) // NOLINT(misc-unused-parameters)
{
  ...
  emcNoisyTowerFinder *calo = new emcNoisyTowerFinder("noisyTowerFinder",inName);
