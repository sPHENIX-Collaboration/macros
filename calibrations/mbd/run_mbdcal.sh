...
mv results/${runno}/pass0_mbd_tt_t0.root results/${runno}/mbd_tt_t0_${runno}.root
mv results/${runno}/pass0_mbd_tq_t0.root results/${runno}/mbd_tq_t0_${runno}.root
...
mv results/${runno}/mbd_qfit.root results/${runno}/mbd_qfit_${runno}.root

echo "###############################################################################################################"
echo "Running pass2.4 calibration"
echo root.exe -q calib_t0mean.C\(\"results/${runno}/calmbdpass2.3_q_${runno}.root\"\)
root.exe -q calib_t0mean.C\(\"results/${runno}/calmbdpass2.3_q_${runno}.root\"\)
mv results/${runno}/mbd_t0corr.root results/${runno}/mbd_t0corr_${runno}.root
