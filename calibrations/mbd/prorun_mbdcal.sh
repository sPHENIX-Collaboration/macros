...
pass=0
echo root.exe -q -b Fun4All_MbdCalReco.C\(\"${inputs}\",${pass},${nevents},\"${dbtag}\"\)
root.exe -q -b Fun4All_MbdCalReco.C\(\"${inputs}\",${pass},${nevents},\"${dbtag}\"\)
echo root.exe -q -b pro_cal_mbd.C\(${runno},${pass}\)
root.exe -q -b pro_cal_mbd.C\(${runno},${pass}\)
...
pass=3
#echo root.exe -q -b cal_mbd.C\(\"${inputs}\",${pass},${nevents},\"${dbtag}\"\)
