                           ...
                           const bool stripRawHit = true)
{
  ...
  G4INTT::UseBadMap = applyHotChannel;
  G4INTT::UseBcoMap = applyBCOCut;
  G4INTT::UseBcoMap = applyADCConversion;
  ...
  Fun4AllOutputManager *out = new Fun4AllDstOutputManager("out", Form("%s", outname.Data()));
  if (stripRawHit)
  {
