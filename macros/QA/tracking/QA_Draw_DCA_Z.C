        ...
        "data/G4sPHENIX.root_qa.root")
{
  ...
  TCanvas *c1 = new TCanvas(TString("QA_Draw_Tracking_DCA_Z") + TString("_") + hist_name_prefix,
                            TString("QA_Draw_Tracking_DCA_Z") + TString("_") + hist_name_prefix,
                            1800, 1000);
  c1->Divide(4, 2);
  int idx = 1;
  TPad *p;
  ...
  TCanvas *c2 = new TCanvas(TString("QA_Draw_Tracking_DCA_Z2") + TString("_") + hist_name_prefix,
                            TString("QA_Draw_Tracking_DCA_Z2") + TString("_") + hist_name_prefix,
                            1800, 1000);
  c2->Divide(4, 2);
  int idx2 = 1;
  TPad *p2;
