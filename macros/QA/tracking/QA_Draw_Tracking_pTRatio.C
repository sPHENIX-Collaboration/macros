...
/*!
 * \file QA_Draw_Tracking_pTRatio.C
 * \brief 
...
//    h_ref->Rebin(1, 2);
  ...
  TCanvas *c1 = new TCanvas(TString("QA_Draw_Tracking_pTRatio"),
                            TString("QA_Draw_Tracking_pTRatio"), 1800, 1000);
  c1->Divide(4, 2);
  int idx = 1;
  TPad *p;
  ...
  for (auto pt_range : gpt_ranges)
  {
    ...
    h_proj_new->GetXaxis()->SetTitle(TString::Format(
        "Reco p_{T}/Truth p_{T}, %.1f - %.1f GeV/c", pt_range.first, pt_range.second));
